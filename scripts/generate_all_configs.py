...
def main() -> None:
    ...
    lines.append("# Services: {count} trading bots + dashboard (Streamlit UI)".format(count=len(services)))
    ...
    lines.append("      --server.port=8501")
    lines.append("      --server.address=0.0.0.0")
